...
def _list_issues(
    ctx: ToolContext, state: str = "open", labels: str = "", limit: int = 20
) -> str:
    ...
    args = [
        ...
        str(min(limit, 50)),
        "--json",
        "number,title,body,labels,createdAt,author,assignees,state",
    ]
    if labels:
...
def _get_issue(ctx: ToolContext, number: int) -> str:
    ...
    args = [
        ...
        str(number),
        "--json",
        "number,title,body,labels,createdAt,author,assignees,state,comments",
    ]
...
def _create_issue(
    ctx: ToolContext, title: str, body: str = "", labels: str = ""
) -> str:
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "limit": {
                            "type": "integer",
                            "default": 20,
                            "description": "Max issues to return (max 50)",
                        },
                    },
                    "required": [],
                },
