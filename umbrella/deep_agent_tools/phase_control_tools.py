        ...
        ToolEntry(
            ...
            schema={
                ...
                "description": (
                    ...
                    "declare intent=real_gui_root_lifecycle and create/update/"
                    "destroy or show a native window/root; "
                    ...
                    "properties": {
                        "capabilities": {
                            ...
                            "description": (
                                ...
                                "{available, source, reason, probe:{kind,intent,command}}. "
                                ...
                                "commands; set probe.intent=real_gui_root_lifecycle "
                                "and create/destroy or show a real GUI root. "
                        ...
                        "probes": {
                            ...
                            "{\"kind\":\"command\",\"intent\":\"real_gui_root_lifecycle\","
                            "\"command\":[\"python\","
